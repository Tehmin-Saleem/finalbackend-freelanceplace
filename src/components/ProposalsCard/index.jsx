...
const ProposalCard = ({
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        const completedresponses = await axios.get(`${process.env.REACT_APP_LOCAL_BASE_URL}/api/client/completed-jobs/${freelancerId}`, {
  ...
  const fetchProposalStatus = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_LOCAL_BASE_URL}/api/client/hire/${ProposalID}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handleChatClick = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${process.env.REACT_APP_LOCAL_BASE_URL}/api/client/proposal/${ProposalID}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
